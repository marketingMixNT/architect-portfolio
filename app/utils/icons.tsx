export const ArrowDownIcon = (props: { className?: string }) => {
	return (
		<svg viewBox='0 0 32 32' version='1.1' xmlns='http://www.w3.org/2000/svg' className={props.className}>
			<g id='SVGRepo_bgCarrier' strokeWidth='0'></g>
			<g id='SVGRepo_tracerCarrier' strokeLinecap='round' strokeLinejoin='round'></g>
			<g id='SVGRepo_iconCarrier'>
				{' '}
				<title>arrow-down-circle</title> <desc>Created with Sketch Beta.</desc> <defs> </defs>{' '}
				<g id='Page-1' stroke='none' strokeWidth='1' fillRule='evenodd'>
					{' '}
					<g id='Icon-Set' transform='translate(-412.000000, -1087.000000)' className={props.className}>
						{' '}
						<path
